#!/bin/bash
# ================================================================
# WOC Netem Test - Stop & Cleanup
# ================================================================
# Stops the cluster and removes network latency injection
...
echo "=================================================="
echo " WOC NETEM TEST Cluster Shutdown"
echo " Clients → Servers → Remove Netem"
echo "=================================================="
...
# ---------------------------------------------------------------
# STEP 2.5 — REMOVE NETEM FROM ALL SERVERS
# ---------------------------------------------------------------
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " STEP 2.5: Removing netem from all server nodes"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# ---------------------------------------------------------------
# STEP 3 — CLEAN UP STALE EVAL DIRECTORIES
# ---------------------------------------------------------------
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " STEP 3: Cleaning up stale eval directories"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# ---------------------------------------------------------------
# STEP 4 — COLLECT EVAL DIRECTORIES FROM REMOTE NODES
# ---------------------------------------------------------------
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " STEP 4: Collecting client eval directories"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

for client_id in $(seq $CLIENT_START_ID $CLIENT_END_ID); do
    vm_index=$((($client_id - $CLIENT_START_ID) % ${#CLIENT_IPS[@]}))
...
# ---------------------------------------------------------------
# STEP 5 — COLLECT SERVER EVAL DIRECTORIES
# ---------------------------------------------------------------
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " STEP 5: Collecting server eval directories"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# ---------------------------------------------------------------
# STEP 6 — MERGE CLIENT CSVs
# ---------------------------------------------------------------
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " STEP 6: Merging client CSVs locally"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# ---------------------------------------------------------------
# STEP 7 — MERGE SERVER CSVs
# ---------------------------------------------------------------
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " STEP 7: Merging server CSVs locally"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo ""
echo "=================================================="
echo " NETEM TEST CLUSTER SHUTDOWN & CLEANUP COMPLETE"
echo "=================================================="
