#!/bin/bash
# ================================================================
# HETERO-5 PLAIN STEADY-STATE RUN (WOC): NUM_SERVERS=5, NUM_CLIENTS=2,
# BATCHSIZE=1, MAX_INFLIGHT=5, INDEP_RATIO=90. Mirrors EPaxos's
# run_plain_b1_r90_2c5s.sh for an apples-to-apples comparison.
# ================================================================
...
cleanup() {
    if [ "$CLUSTER_ACTIVE" = true ]; then
        SERVER_COUNT=5 CLIENT_COUNT=2 bash "$STOP_SCRIPT" || true
    fi
}
trap cleanup EXIT

echo "================================================================"
echo " HETERO-5 PLAIN STEADY-STATE RUN (WOC): indep=90, batch=1, maxinflight=5, 5s/2c"
echo "================================================================"
...
SERVER_COUNT=5 CLIENT_COUNT=2 bash "$STOP_SCRIPT"
CLUSTER_ACTIVE=false
