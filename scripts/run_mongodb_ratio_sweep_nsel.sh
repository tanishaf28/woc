#!/bin/bash
# ================================================================
# MongoDB Ratio Sweep x Cluster Size (WOC)
#
# Sweeps INDEP_RATIO over 100,90,80,60,40,20,10,0 (same points as
# run_mongodb_ratio_sweep_5n.sh / eval_5_i2d_size_sweep.sh) for each
# cluster size in CLUSTER_SIZES (3,5,7,11 servers), against the MongoDB-
# backed cluster (start_mongodb_hetero_nsel.sh, -et=1). BATCHSIZE=1 and
# MSG_SIZE=512 fixed throughout, matching the PlainMsg size sweep.
# ================================================================
...
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║      WOC MONGODB RATIO SWEEP x CLUSTER SIZE (n=3,5,7,11)        ║"
echo "╚════════════════════════════════════════════════════════════════╝"
...
echo ""
echo "=================================================="
echo " WOC MongoDB ratio sweep x cluster size complete"
echo "=================================================="
